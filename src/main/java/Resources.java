...
public class Resources {
    ...
    private List<String> StalkerNicknamesList = Arrays.asList(
    ...
    private List<String> militarySurnames = Arrays.asList(
    ...
    private List<String> militaryRanks = Arrays.asList(
            "Генерал","Полковник","Подполковник","Майор","Капитан","Лейтенант","Прапорщик","Сержант","Рядовой"
    );

    private List<String> groupsList = Arrays.asList(
            "Свобода", "Монолит", "Ренегаты", "Чистое Небо", "Наёмники", "Долг", "Учёные", "Бандиты", "Военные",
            "Одиночки", "Зомбированные"
    );

    private Map<Integer, List<String>> mapOfPlaces = new HashMap<Integer, List<String>>(){{

        put(1, Arrays.asList("1", "2"));
    }};
    public List<String> getStalkerNicknamesList() {
        return StalkerNicknamesList;
    }

    public List<String> getMilitarySurnames() {
        return militarySurnames;
    }

    public List<String> getMilitaryRanks() {
